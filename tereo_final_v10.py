...
# once 'player' gets a correct/incorrect answer it proceeds the next question  
  ...
  # question 1
  print(border1)
  q1 = options(uline + "Question 1/20: What's the job of the macron (ā, ē, ī, ō, ū)?" + end + "\n1) to change the vowel\n2) to shorten the vowel \n3) to ignore the vowel \n4) to lengthen the vowel \n", 0, 4)
  if q1 == 4:
    print(c_grn + "(4) to lengthen the vowel is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (4) to lengthen the vowel was the correct answer.".format(name) + end) 
  print(border2)
  print()  

  # question 2
  print(border1)
  q2 = options(uline + "Question 2/20: What's the translation for “hei tiki”?" + end + "\n1) neck pendant of human form\n2) good luck charm \n3) ear pendant \n4) pendant of good fortune \n", 0, 4)
  if q2 == 1:
    print(c_grn + "(1) neck pendant of human form is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (1) neck pendant of human form was the correct answer.".format(name) + end) 
  print(border2)
  print()  

  # question 3
  print(border1)
  q3 = options(uline + "Question 3/20: What would be stored in a pātaka?" + end + "\n1) waka  \n2) raupanga \n3) kai \n4) pukapuka \n", 0, 4)
  if q3 == 3:
    print(c_grn + "(3) kai is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (3) kai was the correct answer.".format(name) + end) 
  print(border2)
  print()  

  # question 4
  print(border1)
  q4 = options(uline + "Question 4/20: What would you catch with a pā kahawai?" + end + "\n1) manu  \n2) pekeketua \n3) ika \n4) kāunga \n", 0, 4)
  if q4 == 3:
    print(c_grn + "(3) ika is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (3) ika was the correct answer.".format(name) + end) 
  print(border2)
  print()  

  # question 5
  print(border1)
  q5 = options(uline + "Question 5/20: If someone says: “Kei te ngenge ahau”, what are they feeling?" + end + "\n1) hungry  \n2) sad \n3) tired \n4) drunk \n", 0, 4)
  if q5 == 3:
    print(c_grn + "(3) tired is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (3) tired was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 6
  print(border1)
  q6 = options(uline + "Question 6/20: “Aroha ahau ki a koe” means..." + end + "\n1) I love you  \n2) I love you both \n3) I love you all \n4) I love myself \n", 0, 4)
  if q6 == 1:
    print(c_grn + "(1) I love you is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (1) I love you was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 7
  print(border1)
  q7 = options(uline + "Question 7/20: “Rā whānau ki a koe” is what you'd say to someone..." + end + "\n1) on their wedding anniversary \n2) before they go on holiday \n3) on their promotion \n4) on their birthday \n", 0, 4)
  if q7 == 4:
    print(c_grn + "(4) on their birthday is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (4) on their birthday was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 8
  print(border1)
  q8 = options(uline + "Question 8/20: you would wear a hat on your..." + end + "\n1) waewae \n2) upoko \n3) ihu \n4) karu \n", 0, 4)
  if q8 == 2:
    print(c_grn + "(2) upoko is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (2) upoko was the correct answer.".format(name) + end)
  print(border2)
  print()    

  # question 9
  print(border1)
  q9 = options(uline + "Question 9/20: On what day would you say: “Ngā mihi me te aroha nui mō te Rā o te Whaea”?" + end + "\n1) Valentine's Day \n2) Chirstmas Day \n3) Father's Day \n4) Mother's Day \n", 0, 4)
  if q9 == 4:
    print(c_grn + "(4) Mother's Day is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (4) Mother's Day was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 10
  print(border1)
  q10 = options(uline + "Question 10/20: If someone told you “Kei te haere ahau ki te hokomaha” where would they be going?" + end + "\n1) to the supermarket \n2) to school \n3) to the swimming pool \n4) to the park \n", 0, 4)
  if q10 == 1:
    print(c_grn + "(1) to the supermarket is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (1) to the supermarket was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 11
  print(border1)
  q11 = options(uline + "Question 11/20: If you wanted to ask your friend where he's/she's going what would you say?" + end + "\n1) kei hea ko? \n2) kei te haere koe ki hea? \n3) kei te aha te wā? \n4) ko wai tō ingoa? \n", 0, 4)
  if q11 == 1:
    print(c_grn + "(1) kei hea ko? is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (1) kei hea ko? was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 12
  print(border1)
  q12 = options(uline + "Question 12/20: Pango is black, what else is black?" + end + "\n1) mangu \n2) kākāriki \n3) māwhero \n4) parakaraka \n", 0, 4)
  if q12 == 1:
    print(c_grn + "(1) mangu is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (1) mangu was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 13
  print(border1)
  q13 = options(uline + "Question 13/20: Which iwi are from the East Coast of Aotearoa?" + end + "\n1) Ngāti Tuwharetoa \n2) Ngāti Porou \n3) Te Rawara \n4) Tainui \n", 0, 4)
  if q13 == 2:
    print(c_grn + "(2) Ngāti Porou is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (2) Ngāti Porou was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 14
  print(border1)
  q14 = options(uline + "Question 14/20: What kind of fish did Maui pull up from the ocean and became the North Island?" + end + "\n1) a shark \n2) a stingray \n3) a whale \n4) a snapper \n", 0, 4)
  if q14 == 2:
    print(c_grn + "(2) a stingray is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (2) a stingray was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 15
  print(border1)
  q15 = options(uline + "Question 15/20: Matariki is a special time of the year in Aotearoa. Which sentence isn't true?" + end + "\n1) Matariki is always in winter \n2) Matariki's stars can be only seen in Aotearoa \n3) Matariki is known as the beginning of Maori New Year \n4) Matariki has more than one meaning \n", 0, 4)
  if q15 == 2:
    print(c_grn + "(2) Matariki's stars can be only seen in Aotearoa is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (2) Matariki's stars can be only seen in Aotearoa was the correct answer.".format(name) + end) 
  print(border2)
  print()  
  ...
  if q16 == 4:
    ...
    print(c_red + "Good try {}, (4) 1975 was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 17
  print(border1)
  q17 = options(uline + "Question 17/20: When was Māori TV launched?" + end + "\n1) 2000 \n2) 2002 \n3) 2004 \n4) 2006 \n", 0, 4)
  if q17 == 3:
    print(c_grn + "(3) 2004 is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (3) 2004 was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 18
  print(border1)
  q18 = options(uline + "Question 18/20: Which one of these places don't exist in Aotearoa?" + end + "\n1) Kaiwaka \n2) Kaikowhaka \n3) Kaikoura \n4) Kaikohe \n", 0, 4)
  if q18 == 2:
    print(c_grn + "(2) Kaikowhaka is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (2) Kaikowhaka was the correct answer.".format(name) + end)
  print(border2)
  print()  
  ...
  if q19 == 4:
    ...
    print(c_red + "Good try {}, (4) 6 February 1840 was the correct answer.".format(name) + end)
  print(border2)
  print()  

  # question 20
  print(border1)
  q20 = options(uline + "Question 20/20: When was Te Reo Maori recoginzed as an official language?" + end + "\n1) 1 August 1987 \n2) 6 July 1985 \n3) 2 February 1986 \n4) 3 December 1989 \n", 0, 4)
  if q20 == 1:
    print(c_grn + "(1) 1 August 1987 is the correct answer, nice {}!".format(name) + end)
    correct += 1
  else:
    print(c_red + "Good try {}, (1) 1 August, 1987 was the correct answer.".format(name) + end)
  print(border2)
  print()  
